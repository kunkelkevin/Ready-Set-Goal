...
export const homeObjTwo = {
    ...
    description: ' Private training is great, but nothing gets you experiance like playing the game! Jump in, find a match, and get upgrade your skills.',
...
export const homeObjThree = {
    ...
    description: ' "The best part of futbol is it brings together all different kinds of people around to world old and young. Go out and make new friends!',
    buttonLabel: 'Cheers!',
    imgStart: false,
